...
<template>
    <form class="registration-form" @submit.prevent="submitForm" @blur="toggleSingIn(false)">
        <h1 class="registration-form__title">Login</h1>
        <div class="registration-form__item">
            <label class="registration-form__label">Email: </label>
            <input class="registration-form__input" v-model.trim="loginForm.email" type="email">
        </div>
        <div class="registration-form__item">
            <label class="registration-form__label">Password: </label>
            <input class="registration-form__input" v-model.trim="loginForm.password" type="password">
        </div>
